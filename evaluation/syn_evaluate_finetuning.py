...
if __name__=='__main__':
    ...
    for i in range(9,10):
        n = 70*(i+1)
        klstudent_location  = f'data/runs/synthetic-standard-finetuned-N{n}-kldistill-epoch249-seed5.pt'
        logstudent_location = f'data/runs/synthetic-standard-finetuned-N{n}-logitdistill-epoch249-seed5.pt'
    ...
    df_kl.to_csv('data/finetuning_runs_kl_student_standard.csv')
    df_log.to_csv('data/finetuning_runs_log_student_standard.csv')
