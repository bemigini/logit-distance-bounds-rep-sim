...
def evaluate_models_synthetic(teacher_location, klstudent_location, logstudent_location, loader):
    ...
    plot_2d_data(X_test, np.argmax(tlogs, axis=1), filename='data/interpolation/debug-interpolation-input-teacher_logits_synthetic_plot.png', s=2)
    plot_2d_data(X_test, np.argmax(kllogs, axis=1), filename='data/interpolation/debug-interpolation-input-klstudent_logits_synthetic_plot.png', s=2)
    plot_2d_data(X_test, np.argmax(llogs, axis=1), filename='data/interpolation/debug-interpolation-input-logitstudent_logits_synthetic_plot.png', s=2)
    ...
    plot_2d_data(treprs, np.argmax(tlogs, axis=1), filename='data/interpolation/debug-interpolation-teacher_synthetic_plot.png', s=2)
    plot_2d_data(klreprs, np.argmax(kllogs, axis=1), filename='data/interpolation/debug-interpolation-klstudent_synthetic_plot.png', s=2)   
    plot_2d_data(lreprs, np.argmax(llogs, axis=1), filename='data/interpolation/debug-interpolation-logitstudent_synthetic_plot.png', s=2)
    ...
    plt.colorbar()
    plt.savefig('data/interpolation/debug-interpolation-confusion_matrices.png')
...
if __name__=='__main__':
    ...
    rows_kl, rows_log = [], []
    for i in range(1,6):
        klstudent_location  = f'data/runs/synthetic-interpolation-N0-kldistill-epoch249-seed{i}.pt'
        logstudent_location = f'data/runs/synthetic-interpolation-N0-logitdistill-epoch249-seed{i}.pt'
    ...
    df_kl.to_csv('data/interp_runs_kl_student_standard.csv')
    df_log.to_csv('data/interp_runs_log_student_standard.csv')
